...
public class MangohClient {
    ...
    private final static String DEFAULT_ENDPOINT = "mangoh-client";
     ...
     public static void main(final String[] args) {
            ...
            LeshanClient client = createClient(endpoint, localAddress, localPort, secureLocalAddress, secureLocalPort, cl.hasOption("b"),
                    serverURI, pskIdentity, pskKey, null);
            client.start();
        }

        public static LeshanClient createClient(String endpoint, String localAddress, int localPort,
                String secureLocalAddress, int secureLocalPort, boolean needBootstrap, String serverURI,
                byte[] pskIdentity, byte[] pskKey, PositionService positionService) {
            ...
            if(positionService != null) {
            	initializer.setInstancesForObject(LOCATION, new Location(positionService));
             	enablers = initializer.create(SECURITY, SERVER, DEVICE, LOCATION);
            } 
